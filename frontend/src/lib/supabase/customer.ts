...
async function mapTask(t: DbTask): Promise<CustomerTask> {
  ...
  return {
    ...
    courierProvider: (t as any).courier_provider ?? undefined,
    trackingNumber: (t as any).tracking_number ?? undefined,
    dropLat: (t as any).drop_lat != null ? Number((t as any).drop_lat) : undefined,
    dropLng: (t as any).drop_lng != null ? Number((t as any).drop_lng) : undefined,
